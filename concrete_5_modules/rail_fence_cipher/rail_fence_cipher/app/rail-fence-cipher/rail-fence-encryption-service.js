angular.module('railFenceApp.RailFenceCipher.EncryptionService', []);

angular.module('railFenceApp.RailFenceCipher.EncryptionService').service('EncryptionService', function()
{
