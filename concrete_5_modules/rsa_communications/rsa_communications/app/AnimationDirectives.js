...
.directive('graphicsArea', function()
{
    ...
    {
        if (endsWith(scripts[i].src, "AnimationDirectives.js"))
        {
	...
	return {
		restrict: 'E',
		templateUrl: scriptDirectory + '/graphicsTemplate.html',
		scope: {
			graphicsData: "=",
            canvasWidth: "=",
            canvasHeight: "=",
...
.controller('graphicsController', ['$scope', 'AnimationService', 'EncryptionFactory', function graphicsController($scope, AnimationService, EncryptionFactory)
{
    ...
    $('#digestPopoverReceiveAPub').popover();
    $('#digestPopoverReceiveAPriv').popover();
    $('#digestPopoverReceiveBPub').popover();
    $('#digestPopoverReceiveBPriv').popover();
    $('#digestPopoverReceiveNone').popover();

    $('#decryptionPopoverReceiveAPub').popover();
    $('#decryptionPopoverReceiveAPriv').popover();
    $('#decryptionPopoverReceiveBPub').popover();
    $('#decryptionPopoverReceiveBPriv').popover();
    $('#decryptionPopoverReceiveNone').popover();

    
    $('#eveDigestPopoverReceiveAPub').popover();
    $('#eveDigestPopoverReceiveAPriv').popover();
    $('#eveDigestPopoverReceiveBPub').popover();
    $('#eveDigestPopoverReceiveBPriv').popover();
    $('#eveDigestPopoverReceiveNone').popover();

    $('#evePopoverReceiveAPub').popover();
    $('#evePopoverReceiveAPriv').popover();
    $('#evePopoverReceiveBPub').popover();
    $('#evePopoverReceiveBPriv').popover();
    $('#evePopoverReceiveNone').popover();
